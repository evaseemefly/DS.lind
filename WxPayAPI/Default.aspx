...
<body runat="server">
    <div align="center">
        <ul>
            ...
            <li style="background-color: #00CD00"><a href="/example/RefundPage.aspx">订单退款</a></li>
            <li style="background-color: #00CD00"><a href="/example/RefundQueryPage.aspx">退款查询</a></li>
            <li style="background-color: #00CD00"><a href="/example/DownloadBillPage.aspx">下载账单</a></li>
        </ul>
    </div>
</body>
</html>
