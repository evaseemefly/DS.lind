...
namespace Lind.DDD.Events
{
    ...
    public interface IEventBus
    {
        ...
        void Subscribe<TEvent>(Action<TEvent> eventHandlerFunc) where TEvent : class, IEvent;
        /// <summary>
        /// 订阅事件集合
        /// </summary>
        /// <typeparam name="TEvent"></typeparam>
        /// <param name="eventHandlers"></param>
        void Subscribe<TEvent>(System.Collections.Generic.IEnumerable<IEventHandler<TEvent>> eventHandlers) where TEvent : class, IEvent;
        /// <summary>
        /// 取消订阅
        /// </summary>
        /// <typeparam name="TEvent"></typeparam>
        ...
        /// <typeparam name="TEvent"></typeparam>
        /// <param name="eventHandlerFunc"></param>
        void Unsubscribe<TEvent>(Action<TEvent> eventHandlerFunc) where TEvent : class, IEvent;
        /// <summary>
        /// 取消订阅
        /// </summary>
        /// <typeparam name="TEvent"></typeparam>
        /// <param name="eventHandlers"></param>
        void Unsubscribe<TEvent>(System.Collections.Generic.IEnumerable<IEventHandler<TEvent>> eventHandlers) where TEvent : class, IEvent;
        /// <summary>
        /// 取消订阅全部事件
        /// </summary>
        void UnsubscribeAll();
