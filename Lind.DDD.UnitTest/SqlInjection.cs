...
namespace Lind.DDD.UnitTest
{
    ...
    public class UnitTest2
    {
        ...
        public void Select()
        {
            string reg = "[^(and|or|exec|insert|select|union|update|count|*|%)]";
            Console.WriteLine("正则结果1：" + StringHelper.IsSafeSqlString("&name"));
            Console.WriteLine("正则结果2：" + Regex.IsMatch("abc or '1'='1'", reg));
        }
